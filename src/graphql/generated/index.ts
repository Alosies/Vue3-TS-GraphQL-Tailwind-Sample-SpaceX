 ...
 * });
 */
export function useLaunchQuery(variables: LaunchQueryVariables | VueCompositionApi.Ref<LaunchQueryVariables> | ReactiveFunction<LaunchQueryVariables>, options: VueApolloComposable.UseQueryOptions<LaunchQuery, LaunchQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<LaunchQuery, LaunchQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<LaunchQuery, LaunchQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<LaunchQuery, LaunchQueryVariables>(LaunchDocument, variables, options);
}
export function useLaunchLazyQuery(variables: LaunchQueryVariables | VueCompositionApi.Ref<LaunchQueryVariables> | ReactiveFunction<LaunchQueryVariables>, options: VueApolloComposable.UseQueryOptions<LaunchQuery, LaunchQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<LaunchQuery, LaunchQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<LaunchQuery, LaunchQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<LaunchQuery, LaunchQueryVariables>(LaunchDocument, variables, options);
}
export type LaunchQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<LaunchQuery, LaunchQueryVariables>;
 ...
 * });
 */
export function useLaunchesQuery(variables: LaunchesQueryVariables | VueCompositionApi.Ref<LaunchesQueryVariables> | ReactiveFunction<LaunchesQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<LaunchesQuery, LaunchesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<LaunchesQuery, LaunchesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<LaunchesQuery, LaunchesQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<LaunchesQuery, LaunchesQueryVariables>(LaunchesDocument, variables, options);
}
export function useLaunchesLazyQuery(variables: LaunchesQueryVariables | VueCompositionApi.Ref<LaunchesQueryVariables> | ReactiveFunction<LaunchesQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<LaunchesQuery, LaunchesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<LaunchesQuery, LaunchesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<LaunchesQuery, LaunchesQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<LaunchesQuery, LaunchesQueryVariables>(LaunchesDocument, variables, options);
}
export type LaunchesQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<LaunchesQuery, LaunchesQueryVariables>;
 ...
 *
 * To run a query within a Vue component, call `useLaunchesPastQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchesPastQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 ...
 */
export function useLaunchesPastQuery(options: VueApolloComposable.UseQueryOptions<LaunchesPastQuery, LaunchesPastQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<LaunchesPastQuery, LaunchesPastQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<LaunchesPastQuery, LaunchesPastQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<LaunchesPastQuery, LaunchesPastQueryVariables>(LaunchesPastDocument, {}, options);
}
export function useLaunchesPastLazyQuery(options: VueApolloComposable.UseQueryOptions<LaunchesPastQuery, LaunchesPastQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<LaunchesPastQuery, LaunchesPastQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<LaunchesPastQuery, LaunchesPastQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<LaunchesPastQuery, LaunchesPastQueryVariables>(LaunchesPastDocument, {}, options);
}
export type LaunchesPastQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<LaunchesPastQuery, LaunchesPastQueryVariables>;